...
## Inference
We have already pre-processed and fine-tuned our model so you can directly use below command to run the app but before that download the files given on this link () and add it to the main/output folder
```
